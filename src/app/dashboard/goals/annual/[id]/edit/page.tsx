...
export default function EditAnnualGoalPage() {
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              <Button
                ...
                size="sm"
                className="gap-2"
                onClick={() => router.push(`/dashboard/goals/annual/${goal.id}`)}
              >
                <ArrowLeft className="h-4 w-4" />
                Back to Goal
              </Button>
              <h1 className="text-2xl font-semibold tracking-tight">Edit Annual Goal</h1>
              <p className="text-sm text-muted-foreground">
                Update your annual goal, key results, and metrics.
              </p>
            </div>
          </div>
